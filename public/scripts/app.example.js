class App {
  constructor() {
    ...
    this.penumpang = document.getElementById("form_passenger");
  }
  ...
  run = () => {
    ...
    Car.list.forEach((car) => {
      ...
      let tanggalAvail = Date.parse(car.availableAt)
      
      if (car.available == supir && tanggalAvail >= formdate && car.capacity >= penumpang) {
